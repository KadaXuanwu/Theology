...
Open source checks for `Theology/Arguments Against/Condemned for One Honest Mistake.md`. Format is in [README.md](README.md).
...
Sentences: 0 checked | 0 supported | 0 fixed | 0 cut | 0 unopened | 0 protected-flag. The verifier was spawned and terminated on an account rate limit before it opened a single source. Nothing in the new text has been checked cold.
Effort: not assessed. The effort check is the verifier's and it did not run.
Rulings: crux held in both orders | strong counter held in both orders
...
### V1. The crux was not settled, and one lexicon plus one commentary would settle it
**Status:** open
**Node:** `Arguments Against/Condemned for One Honest Mistake`
**Source:** BDAG (Bauer, Danker, Arndt and Gingrich), *A Greek-English Lexicon of the New Testament*, 3rd edn (University of Chicago Press, 2000), on πιστεύω εἰς plus accusative; and any one of Raymond Brown (Anchor Bible 29, 1966), C. K. Barrett, Craig Keener (2003), Andrew Lincoln (BNTC, 2005), Marianne Meye Thompson (NTL, 2015), Jörg Frey (WUNT 117, 2000) or Jean Zumstein (CNT IVa, 2014) on John 3:18–21
**What the node says:** the first bullet under Limits names this as what the argument stands or falls on, and says neither was opened.
**What is open:** whether the verse's own stated ground, the ὅτι clause, reaches a person who examined the claim and was not convinced, or picks out only a person who set himself against what he was shown. Both debaters asked for exactly these two sources and two research passes could not reach either. archive.org's full-text search API is dead from this environment; every copy of Brown is lending-restricted; Keener and Lincoln are not held there at all; the Google Books API key is over quota; SAGE, Mohr Siebeck, De Gruyter and bible.org all return 403.
**What would settle it:** BDAG on the construction, and one modern commentary on the passage, at full access.
**Verdict:**
**Checked by:**

---

### V2. The node was never fact checked cold
**Status:** open
**Node:** `Arguments Against/Condemned for One Honest Mistake`
**Source:** the whole node
**What the node says:** everything.
**What is open:** the verifier agent was given the draft, the source list and the protection list, and terminated on an account rate limit before opening a source. No sentence in the new text has a `pass`. The research behind each sentence was done and quoted by the researcher who found it, which is not the same thing: the cold re-check exists precisely because a researcher who found a source is primed to read it favourably.
**What would settle it:** re-run Phase 4 of `refresh-node` on the node as it now stands, with `existing.md` as the protection list.
**Verdict:**
**Checked by:**

---

### V3. Sources carrying sentences at less than full access
**Status:** open
**Node:** `Arguments Against/Condemned for One Honest Mistake`
**Source:** at abstract: Teresa Morgan (2015), Chris Seglenieks (2020), Douglas V. Henry (2001 and 2008), Andrew Blanton (2026), Michael Rea (2018), Jerry Walls (1992), Oliver Crisp (2003), Nikk Effingham (2024), Kenneth Himma (2003). At snippet: Denny Burk (2016), reached only through reviews. At none, reached through a source opened at full: Adams 1993 and Kvanvig (through Talbott's *Stanford Encyclopedia* entry), Drange 1993 (through the encyclopedia's classification), the *Editio Critica Maior* of Mark 2021 (through Head), Rahner 1961/1966 and Berger 1999 (through Bullivant and Pollack), Feldman 2000 (through McCormick), Alston, Peels's book and Rettler (through the *Stanford Encyclopedia*).
**What the node says:** each is cited for the position or finding named in the node's prose.
**What is open:** none of these was opened at full access on this run. Under the source policy a load-bearing claim needs Tier A at full, and the verifier pass that would have ruled on which of these sentences are load-bearing did not happen.
**What would settle it:** opening each, or the verifier ruling that the sentence it carries is not load-bearing.
**Verdict:**
**Checked by:**

---

### V4. Peels's condition is quoted through the encyclopedia, not from the book
**Status:** open
**Node:** `Arguments Against/Condemned for One Honest Mistake`
**Source:** Rik Peels, *Responsible Belief: A Theory in Ethics and Epistemology* (Oxford University Press, 2017), 12 and ch. 2
**What the node says:** that Peels "makes responsible belief turn on having had control over what influenced it and having broken no intellectual obligation", and in Limits that he states his condition for believing something responsibly rather than for responsibly failing to believe it.
**What is open:** the page 12 biconditional was confirmed only as the *Stanford Encyclopedia of Philosophy* quotes it. Oxford Academic renders navigation only behind its paywall, PhilPapers returned 403, and Google Books did not surface the passage. Peels's own 2019 reply in the *Journal of Philosophical Research* was opened at full and corroborates the substance without giving the page 12 wording.
**What would settle it:** the book at p. 12 and ch. 2. The second half of the question, whether the condition extends to responsible non-belief, is the node's own reading and the book would settle that too.
**Verdict:**
**Checked by:**

---

### V5. Brian Cutter's answer to the size half was left out entirely
**Status:** open
**Node:** `Arguments Against/Condemned for One Honest Mistake`
...
**What is open:** the philosopher's ruling called this "the live unargued answer" on the proportionality half: Cutter grants that no one's earthly deeds merit infinite punishment and instead denies that everlasting suffering amounts to an infinitely severe punishment. PhilArchive returned 403 to two separate passes, so it was reached only at snippet and could not carry a sentence.
**What would settle it:** the full text. If it says what the snippet says, it belongs in Countered By as the strongest current answer to the node's size half.
**Verdict:**
**Checked by:**
...
### V7. The Söding lecture script was read two ways by two researchers
**Status:** open
**Node:** `Arguments Against/Condemned for One Honest Mistake`
**Source:** Thomas Söding, *„Im Anfang war das Wort". Das Johannesevangelium*, Vorlesungsskript SS 2010, Ruhr-Universität Bochum, 53–54
