...
/* Keeping the tree on the note you are reading ----------------------------
...

{
  ...
  if (item?.height && sidebar.scrollHeight > sidebar.clientHeight + 1) {
    const box = sidebar.getBoundingClientRect()
    // Enough room that the entry lands inside the list rather than flush
    // against an edge, where it looks cut off.
    const margin = 48
