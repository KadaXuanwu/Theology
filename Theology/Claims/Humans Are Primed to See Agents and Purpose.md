...
# Carries
- Widespread religious belief needs no supernatural cause. A natural tendency accounts for how common it is.
- The instinct is real. Anything built on the idea that people naturally reach for a maker has that much conceded to it, and conceding it is better than fighting it.
- What the instinct produces is agents, spirits and purpose, not one creator. The distance between those two is where the claim does its work.
- It gives the natural mechanism for why confirmation tends to show up once someone is already committed and looking for it. That reaches any method that puts the commitment before the evidence.

# Disputed By
- Nothing here settles the question either way. A belief being natural does not make it true, and does not make it false either. Barrett, who ran the largest project on this, said so directly.
