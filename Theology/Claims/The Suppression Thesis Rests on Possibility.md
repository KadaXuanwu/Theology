...
# Based On
- That group retreats to possibility. Plantinga claims for his model "only that it is (1) possible, (2) subject to no philosophical objections that do not assume that Christian belief is false", at p. 351.[^plantinga-wcb] James Dominic Rooney writes that "for purposes of rejecting the divine hiddenness argument, we do not need to prove that the biblical account of original sin is correct but only that it is possible some such culpable resistance to God occurred", at p. 648.[^rooney-2024]
