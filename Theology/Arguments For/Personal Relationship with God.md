...
# Based On
- [[Obedience Comes Before Evidence]] is the scriptural case for the leap coming first.
...
- [[Humans Are Primed to See Agents and Purpose]] gives the natural mechanism for why confirmation shows up once someone is committed and looking for it.
- [[Demanding Belief Without the Proof]] the evidence is placed where only people who already jumped can reach it, which is the complaint.

# Limits
- "Best way to confirm" is a strong claim and undefended. It needs either narrowing to "the way most believers actually arrive" or a real argument that experience beats the alternatives.
- The leap has no stated content. What exactly is being tried, and what would count as it not working, are both open. Without an answer to the second, the method cannot fail.
