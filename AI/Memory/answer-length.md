...
Answers in chat stay short and concise. This is in `AGENTS.md` already; it is here because it kept slipping on multi part UI and design work, where every finished change came back as a long write up with tables of measurements, contrast ratios, per file breakdowns and paragraphs of reasoning.
...
- Never narrate the work. Problems hit, bugs found in your own code, near misses and how they were fixed are all noise. Fix it and move on. Sharpened in `AGENTS.md` on 2026-08-30 after a run of replies that reported every issue solved along the way.
...
- A request for a suggestion is different: print the suggestion formatted to copy and paste, per `AGENTS.md`.
