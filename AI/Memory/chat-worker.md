...
Untested lever, if latency is worth another look: `MODEL = "gemini-3.6-flash"` instead of Flash Lite. Flash Lite is the cheapest tier and plausibly the most contended, and full Flash is still free tier. Measure it the same way, a batch of eight timed requests, before keeping it.
