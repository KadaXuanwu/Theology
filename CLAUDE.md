Check out Google Drive/Notes/Theology before you respond.
The local Theology folder is a manual copy from Google Drive, meant for you to work on it when I say so. It might not be up to date, so only look at it and work in it it if I explicitly tell you so.
...
You can't edit files on Google Drive directly, so instead print your suggestions directly into the chat unless stated differently. Make sure to format it so that I can just copy and paste it.
...
You can commit and push changes after edits.